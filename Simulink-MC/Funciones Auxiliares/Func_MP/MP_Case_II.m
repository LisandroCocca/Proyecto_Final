function [] = MP_Case_II(Car_Data, Control_Data, Error_Data, ~ , Map_Data, Model_Data, Plot_Data, Ref_Data)
% Plot XY
FigI = figure ('Units','normalized','OuterPosition',Plot_Data.Blockfig);
color = [0 77 0]/255;
plot (Ref_Data.XY(:,1),Ref_Data.XY(:,2),'Color',color,'LineStyle','--');
hold on
plot (Car_Data.Case_II.XY_2(:,1),Car_Data.Case_II.XY_2(:,2),'Color',color);
grid on
...
hold on
plot (Ref_Data.tout,Car_Data.Case_II.XY_2(:,1),'Color',color);
grid on
...
hold on
plot (Ref_Data.tout,Car_Data.Case_II.XY_2(:,2),'Color',color);
grid on
...
hold on
plot (Ref_Data.tout,Car_Data.Case_II.V_2_2(:,1),'Color',color);
grid on
...
plot(Ref_Data.tout,Control_Data.Case_II.Fx_2,'Color',color);
grid on
...
subplot(2,4,8)
color = [0, 0, 0] / 255;
plot(Ref_Data.tout,Control_Data.Case_II.delta_deg,'Color',color);
grid on
...
suptitle (['Case II - Modelos: ',Model_Data.Case_II.model_alias,' - Map: ',Map_Data.map_name])
